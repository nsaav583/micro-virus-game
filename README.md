...
**Micro Virus** es un videojuego 2D del género *top-down shooter*, desarrollado con **Godot Engine 4.5** como proyecto académico para la asignatura de Desarrollo de Videojuegos.
...
- Interfaz HUD con información en tiempo real
- Música de fondo persistente y efectos de sonido
